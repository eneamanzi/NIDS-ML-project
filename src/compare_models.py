...
CICIOT_DIR = DATA_DIR / "CICIOT23"  # Il Test set è sempre qui

# Cartelle Output e Modelli
MODELS_DIR = BASE_DIR / "models"    # Cartella base dei modelli
OUTPUT_DIR = BASE_DIR / "docs"      # Cartella per report e grafici

# =============================================================================
# CONFIGURAZIONE MODELLI
# =============================================================================

# Definiamo i percorsi assoluti usando pathlib
MODEL_PATHS = {
    'Decision Tree': MODELS_DIR / 'DecisionTree_CICIoT2023_multiclass.pkl',
    'Random Forest': MODELS_DIR / 'RandomForest_CICIoT2023_multiclass.pkl',
    'k-NN':          MODELS_DIR / 'kNN_CICIoT2023_multiclass.pkl',
    'SVM':           MODELS_DIR / 'SVM_CICIoT2023_multiclass.pkl'
}
...
def load_test_data(data_dir):
    ...
    test_path = data_dir / 'test_processed.pkl'
...
def plot_comparison(df, output_dir):
    ...
    plt.suptitle('Model Performance Comparison - CICIoT2023', fontsize=16)
    plt.tight_layout()
    plt.savefig(output_dir / 'model_metrics_comparison.png', dpi=150)
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(output_dir / 'accuracy_vs_latency_tradeoff.png', dpi=150)
    plt.close()
...
if __name__ == '__main__':
    ...
    try:
        # 1. Load Data
        X_test, y_test = load_test_data(CICIOT_DIR)
        
        # 2. Load Models
        models = load_models()
        
        if not models:
            print(f"\n❌ No models found in {MODELS_DIR}! Run training scripts first.")
            exit()
        ...
        # 5. Save & Plot
        # Assicurati che OUTPUT_DIR esista
        OUTPUT_DIR.mkdir(parents=True, exist_ok=True)
